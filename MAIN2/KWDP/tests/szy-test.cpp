...
std::string INPUT_1 = "1 5 Szyfr_Cezara_jest_skuteczny!";
std::string CORRECT_ANSWER_1 = "Xedkw_Hjefwf_ojxy_xpzyjhesd!";
std::string INCORRECT_ANSWER_1 = "0";

std::string INPUT_2 = "2 5 Xedkw_Hjefwf_ojxy_xpzyjhesd!";
std::string CORRECT_ANSWER_2 = "Szyfr_Cezara_jest_skuteczny!";

std::string INPUT_3 = "1 24 xyz";
std::string CORRECT_ANSWER_3 = "vwx";

...
std::string INPUT_1 = "5 7";
std::string CORRECT_ANSWER_1 = "I";
std::string INCORRECT_ANSWER_1 = "0";

std::string INPUT_2 = "0 -1000000000";
std::string CORRECT_ANSWER_2 = "OY";

std::string INPUT_3 = "0 0";
std::string CORRECT_ANSWER_3 = "0";
